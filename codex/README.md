...
这是 `cppCNN_vibecoding` 仓库的 Codex 实现，当前稳定版本为 `v1.0.0`。项目使用 C++17 从零实现 LeNet 风格 CNN 的 Tensor、卷积、池化、激活、全连接、Softmax、损失、反向传播、训练和模型持久化，并使用 Qt Quick/QML 提供现代桌面界面。
